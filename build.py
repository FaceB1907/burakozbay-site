  ...
  <section class="split-hero">
    ...
    <div class="split-hero__text">
      <div>
        ...
        <div class="ai-projects-widget">
          <div class="eyebrow" style="margin-bottom:18px">Diğer Projelerim</div>
          <div class="ai-projects-row">
            <a href="https://kodonext.com" target="_blank" rel="noopener" class="ai-project-item">
              <span class="ai-project-icon"><img src="images/partners/kodo-logo.png" alt="KODO Next AI"></span>
              <span class="ai-project-label">kodonext.com</span>
            </a>
            <a href="https://iris.kodonext.com" target="_blank" rel="noopener" class="ai-project-item">
              <span class="ai-project-icon"><img src="images/partners/iris-logo.png" alt="Iris — KODO Next AI"></span>
              <span class="ai-project-label">iris.kodonext.com</span>
            </a>
            <a href="https://bella.kodonext.com" target="_blank" rel="noopener" class="ai-project-item">
              <span class="ai-project-icon"><img src="images/partners/kodobella-logo.png" alt="KODOBella" onerror="this.parentElement.parentElement.style.display='none'"></span>
              <span class="ai-project-label">KODOBella</span>
            </a>
          </div>
        </div>
        <style>
          .ai-projects-widget{{
            margin-top:24px; padding:26px 30px; width:fit-content; max-width:100%;
            background:radial-gradient(120% 170% at 50% 0%, #F2EBDC 0%, var(--paper-dim) 55%, #E6DECB 100%);
            border-radius:26px;
            box-shadow:inset 0 3px 14px rgba(30,27,22,.12), inset 0 -2px 6px rgba(255,255,255,.55);
          }}
          .ai-projects-row{{ display:flex; gap:28px }}
          .ai-project-item{{ display:flex; flex-direction:column; align-items:center; gap:10px; text-decoration:none; color:inherit; width:84px }}
          .ai-project-icon{{
            width:56px; height:56px; border-radius:16px; background:var(--paper);
            display:flex; align-items:center; justify-content:center;
            box-shadow:0 10px 22px rgba(30,27,22,.18), 0 2px 5px rgba(30,27,22,.09);
            transition:transform .28s ease, box-shadow .28s ease;
            animation:ai-float 4.5s ease-in-out infinite;
          }}
          .ai-project-item:nth-child(2) .ai-project-icon{{ animation-delay:.5s }}
          .ai-project-item:nth-child(3) .ai-project-icon{{ animation-delay:1s }}
          .ai-project-icon img{{ width:34px; height:34px; object-fit:contain }}
          .ai-project-item:hover .ai-project-icon{{ transform:translateY(-5px) scale(1.07); box-shadow:0 16px 28px rgba(30,27,22,.22), 0 4px 9px rgba(30,27,22,.11) }}
          .ai-project-label{{ font-size:12px; font-weight:600; text-align:center; line-height:1.3; color:var(--ink-soft) }}
          @keyframes ai-float{{ 0%,100%{{ transform:translateY(0) }} 50%{{ transform:translateY(-5px) }} }}
          @media (max-width:600px){{ .ai-projects-widget{{ width:100%; box-sizing:border-box }} .ai-projects-row{{ justify-content:space-between }} }}
        </style>
      </div>
    </div>
  </section>
